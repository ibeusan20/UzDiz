...
<body>
	...
	<ul>
		...
		<li><a
			href="${pageContext.servletContext.contextPath}/mvc/tvrtka/kraj">Šalji
				komandu za kraj</a></li>
		<li><a
		...
		<li><a
			href="${pageContext.servletContext.contextPath}/mvc/tvrtka/partner">Pregled
				partnera</a></li>
		<li><a
			href="${pageContext.servletContext.contextPath}/mvc/tvrtka/privatno/obracun">Pregled
				obračuna</a></li>
		<li><a
