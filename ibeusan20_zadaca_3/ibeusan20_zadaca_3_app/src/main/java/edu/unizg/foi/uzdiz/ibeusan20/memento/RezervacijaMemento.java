...
public record RezervacijaMemento(
    String ime,
    String prezime,
  ...
  private static StanjeRezervacije mapirajStanje(String naziv) {
    ...
    if (n.contains("CEKANJ") || n.contains("CEKANJU")) return StanjeNaCekanjuRezervacija.instanca();
    if (n.contains("ODGOD")) return StanjeOdgodenaRezervacija.instanca();
