...
public class KomandaDrta implements Komanda {
    ...
    public boolean izvrsi() {
        ...
        // provjera postoji li već rezervacija za tu osobu i aranžman
        boolean postoji = upraviteljRezervacija.postojiRezervacija(ime, prezime, oznaka);
        if (postoji) {
            System.out.println("Rezervacija za " + ime + " " + prezime + " već postoji za aranžman " + oznaka + ".");
            return true;
        }
        ...
        System.out.println("Dodana rezervacija za " + ime + " " + prezime + 
                           " (aranžman " + oznaka + ") u " + datumVrijeme + ".");
        return true;
    }
}
